...
import com.banking.transctions.exception.ResourceNotFoundException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<?>> handelInputNotValidException(MethodArgumentNotValidException exception){
